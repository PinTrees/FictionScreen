...
/// Samsung One UI 6.1 최신 스타일 Quick Panel (빠른 설정 & 알림 창)
class GalaxyQuickPanel extends StatefulWidget {
  final String timeString;
  final String dateString;
  final VoidCallback onClose;
  final VoidCallback? onOpenSettings;

  const GalaxyQuickPanel({
    super.key,
  ...
  @override
  State<GalaxyQuickPanel> createState() => _GalaxyQuickPanelState();
}

class _GalaxyQuickPanelState extends State<GalaxyQuickPanel> {
  bool _isWifiOn = true;
                ...
                children: [
                        ...
                        Row(
                          children: [
                            ...
                            InkWell(
                              ...
                              child: const Icon(CupertinoIcons.power, size: 20, color: Colors.white70),
                            ),
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          // 1. One UI 6.1 큰 피약형 메인 토글 패널 (Wi-Fi & Bluetooth)
                          Row(
                            children: [
                              Expanded(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: image != null
                                            ...
                                            : Container(
                                                ...
                                                child: const Icon(CupertinoIcons.bell_fill, size: 16, color: Colors.white),
                                              ),
                                      ),
                                    ),
                                    const SizedBox(width: 12),
