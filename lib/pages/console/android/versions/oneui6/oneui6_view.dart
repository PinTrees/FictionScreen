...
import 'widgets/oneui6_quick_panel.dart';

/// Samsung Galaxy One UI 6.1 스타일 모바일 홈스크린 뷰
class OneUi6View extends StatefulWidget {
  ...
  @override
  State<OneUi6View> createState() => _OneUi6ViewState();
}

class _OneUi6ViewState extends State<OneUi6View> {
              ...
              children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(widget.timeString, style: const TextStyle(color: Colors.white, fontSize: 34, fontWeight: FontWeight.bold)),
                            Text(widget.dateString, style: const TextStyle(color: Colors.white70, fontSize: 13)),
                          ],
                        ),
                        const Row(
                          children: [
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 10),
                      Expanded(child: Text('Google 검색 또는 URL 입력', style: TextStyle(color: Colors.white60, fontSize: 12))),
                ...
                Expanded(
                  child: GridView.count(
                    ...
                    children: [
                      OsAppItem(title: '전화', icon: CupertinoIcons.phone_fill, iconColor: Colors.white, backgroundColor: const Color(0xFF10B981), isDesktop: false, onTap: () => _openGalaxyApp('phone')),
                      OsAppItem(title: '메시지', icon: CupertinoIcons.chat_bubble_text_fill, iconColor: Colors.white, backgroundColor: const Color(0xFF3B82F6), isDesktop: false, onTap: () => _openGalaxyApp('messages')),
                      OsAppItem(title: '갤러리', icon: CupertinoIcons.photo_fill_on_rectangle_fill, iconColor: Colors.white, backgroundColor: const Color(0xFFF59E0B), isDesktop: false, onTap: () => _openGalaxyApp('gallery')),
                      OsAppItem(title: '인터넷', icon: CupertinoIcons.globe, iconColor: Colors.white, backgroundColor: const Color(0xFF6366F1), isDesktop: false, onTap: () => _openGalaxyApp('internet')),
                ...
                Container(width: 120, height: 4, decoration: BoxDecoration(color: Colors.white60, borderRadius: BorderRadius.circular(4))),
              ],
            ),
          ),
        ),
  ...
  Widget _buildGalaxyWallpaper() {
    switch (widget.currentWallpaper) {
      ...
      default:
        return Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF0A2540), Color(0xFF0D3B66), Color(0xFF101820)]),
          ),
        );
    }
  }
