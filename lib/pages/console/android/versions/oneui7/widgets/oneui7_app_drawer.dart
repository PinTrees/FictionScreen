...
/// Samsung One UI 7 플래그십 전체 앱 서랍 (App Drawer)
class OneUi7AppDrawer extends StatefulWidget {
  ...
  @override
  State<OneUi7AppDrawer> createState() => _OneUi7AppDrawerState();
}

class _OneUi7AppDrawerState extends State<OneUi7AppDrawer> {
  String _searchQuery = '';
                    ...
                    child: Padding(
                      ...
                      child: GridView.count(
                        ...
                        children: _filterApps([
                          ...
                          _AppEntry('메시지', CupertinoIcons.chat_bubble_text_fill, const Color(0xFF3B82F6), () => widget.onOpenGalaxyApp('messages')),
                          _AppEntry('갤러리', CupertinoIcons.photo_fill_on_rectangle_fill, const Color(0xFFF59E0B), () => widget.onOpenGalaxyApp('gallery')),
                          _AppEntry('인터넷', CupertinoIcons.globe, const Color(0xFF6366F1), () => widget.onOpenGalaxyApp('internet')),
