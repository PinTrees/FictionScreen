...
/// Samsung Galaxy One UI 7 상단 상태바 (펀치홀 카메라 & 스플릿 제스처 분기)
class OneUi7StatusBar extends StatelessWidget {
  final String timeString;
  final VoidCallback onOpenQuickSettings;
  final VoidCallback onOpenNotificationShade;

  const OneUi7StatusBar({
    super.key,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          // 좌측 영역 (시각, 통신사/알림 인디케이터) -> 스와이프/탭 시 알림 셰이드
          Expanded(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          Text('96', style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
                          SizedBox(width: 2),
