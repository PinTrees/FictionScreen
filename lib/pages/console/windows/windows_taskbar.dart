                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildTaskbarIcon(CupertinoIcons.videocam_fill, const Color(0xFFE53935), '보안 관제 (CCTV)', () => onOpenWinApp?.call('cctv')),
                        _buildTaskbarIcon(null, Colors.transparent, 'Steam', () => onOpenWinApp?.call('steam'), imageAsset: 'assets/images/steam_icon.webp'),
                        _buildTaskbarIcon(CupertinoIcons.tv_fill, const Color(0xFFD32F2F), '뉴스 속보 (TV)', () => onOpenWinApp?.call('news')),
                        _buildTaskbarIcon(null, Colors.transparent, '디시인사이드', () => onOpenWinApp?.call('dcinside'), imageAsset: 'assets/images/dcinside_icon.webp'),
                        ...
                        _buildTaskbarIcon(null, const Color(0xFF107C41), 'Excel', () => onOpenTemplate('excel'), imageAsset: 'assets/images/excel_icon.webp'),
                        _buildTaskbarIcon(null, const Color(0xFFD83B01), 'PowerPoint', () => onOpenTemplate('powerpoint'), imageAsset: 'assets/images/powerpoint_icon.webp'),
                        _buildTaskbarIcon(null, const Color(0xFF185ABD), 'Word', () => onOpenTemplate('word'), imageAsset: 'assets/images/word_icon.webp'),
                        ...
                        _buildTaskbarIcon(null, const Color(0xFFFF0000), 'YouTube', () => onOpenTemplate('youtube'), imageAsset: 'assets/images/youtube_icon.webp'),
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  _buildXpTaskbarTab('보안 관제 (CCTV)', 'assets/images/windows/desk.png', () => onOpenWinApp?.call('cctv')),
                  _buildXpTaskbarTab('Steam', 'assets/images/steam_icon.webp', () => onOpenWinApp?.call('steam')),
                  _buildXpTaskbarTab('뉴스 속보 (TV)', 'assets/images/windows/desk.png', () => onOpenWinApp?.call('news')),
                  _buildXpTaskbarTab('디시인사이드', 'assets/images/dcinside_icon.webp', () => onOpenWinApp?.call('dcinside')),
                  ...
                  _buildXpTaskbarTab('Excel', 'assets/images/excel_icon.webp', () => onOpenTemplate('excel')),
                  _buildXpTaskbarTab('PowerPoint', 'assets/images/powerpoint_icon.webp', () => onOpenTemplate('powerpoint')),
                  _buildXpTaskbarTab('Word', 'assets/images/word_icon.webp', () => onOpenTemplate('word')),
                ],
              ),
            ),
          ),
