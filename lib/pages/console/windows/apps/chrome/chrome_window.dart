...
class _WindowsChromeWindowState extends State<WindowsChromeWindow> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                _buildChromeTab(0, 'Google', _activeTab == 0),
                const SizedBox(width: 4),
                const Icon(CupertinoIcons.add, size: 14, color: Colors.white54),
              ],
            ),
          ),
  ...
  Widget _buildChromeTab(int index, String title, bool isSelected) {
    return Container(
      width: 160,
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 6),
          Expanded(
            child: Text(title, style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w500), overflow: TextOverflow.ellipsis),
          ),
