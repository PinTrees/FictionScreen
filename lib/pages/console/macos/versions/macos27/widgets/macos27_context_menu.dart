...
/// macOS 27 Golden Gate 데스크톱 우클릭 컨텍스트 메뉴
/// - Liquid Glass 반투명 블러 머티리얼
/// - 네이티브 macOS 우클릭 항목 (새로운 폴더, 배경화면 변경, 시스템 설정, OS 전환 등)
class Macos27ContextMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double menuTop = position.dy.clamp(10.0, screenSize.height - 290.0);
