              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildDockItem(17, '카카오톡 채팅 에디터', 'assets/images/kakaotalk_icon.webp', templateId: 'kakaotalk'),
                    _buildDockItem(18, 'Instagram 에디터', 'assets/images/instagram_icon.webp', templateId: 'instagram'),
                    _buildDockItem(19, 'Toss 에디터', 'assets/images/toss_icon.webp', templateId: 'toss'),
                    _buildDockItem(20, '카카오뱅크 에디터', 'assets/images/kakaobank_icon.webp', templateId: 'kakaobank'),
                    _buildDockItem(21, '당근마켓 에디터', 'assets/images/daangn_icon.webp', templateId: 'daangn'),
                    _buildDockItem(22, 'X (Twitter) 에디터', 'assets/images/x_twitter_icon.webp', templateId: 'x_twitter'),
                    _buildDockItem(23, 'YouTube 에디터', 'assets/images/youtube_icon.webp', templateId: 'youtube'),
                    _buildDockItem(24, '배달의민족 에디터', 'assets/images/baemin_icon.webp', templateId: 'delivery'),
                    _buildDockItem(25, '야놀자 에디터', 'assets/images/yanolja_icon.webp', templateId: 'yanolja'),
                    _buildDockItem(26, '업비트 에디터', 'assets/images/upbit_icon.webp', templateId: 'upbit'),
                    _buildDockItem(27, '블라인드 에디터', 'assets/images/blind_icon.webp', templateId: 'blind'),
                    _buildDockItem(28, '디스코드 에디터', 'assets/images/discord_icon.webp', templateId: 'discord'),
                    _buildDockItem(29, '포토샵 에디터', 'assets/images/photoshop_icon.webp', templateId: 'photoshop'),
                    _buildDockItem(30, 'Visual Studio 2026', 'assets/images/visual_studio_icon.webp', templateId: 'visual_studio'),
                    _buildDockItem(31, 'DaVinci Resolve', 'assets/images/davinci_resolve_icon.webp', templateId: 'davinci_resolve'),

                    _buildDockDivider(),

                    _buildDockItem(32, '랜딩 홈으로 이동', null, icon: CupertinoIcons.house_fill, isHome: true),
                ],
              ),
            ),
          ),
