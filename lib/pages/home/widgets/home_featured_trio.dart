      ...
      child: Column(
        children: [
          ...
          _buildFeatureSection(
            ...
            previewChild: DeviceFramePreview(
              isDesktop: false,
          ...
          // 2. 당근마켓 (Daangn) Section
          _buildFeatureSection(
            context: context,
            badge: '중고거래 • 일상/스릴러 필수',
            badgeColor: const Color(0xFFFF6F0F),
            ...
            previewChild: DeviceFramePreview(
              isDesktop: false,
              child: DaangnScreen(config: DaangnConfig.defaultPreset()),
            ),
            templateId: 'daangn',
          ...
          // 3. 블라인드 (Blind) Section
          _buildFeatureSection(
            context: context,
            badge: '사내 커뮤니티 • 직장인/기업물 킬러',
            badgeColor: const Color(0xFFDA3238),
            badgeTextColor: Colors.white,
            ...
            previewChild: DeviceFramePreview(
              isDesktop: true,
              child: BlindScreen(config: BlindConfig.defaultPreset()),
            ),
            templateId: 'blind',
  ...
  Widget _buildFeatureSection({
    ...
    final textColumn = Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: badgeColor.withValues(alpha: isDarkMode ? 0.2 : 0.15),
            borderRadius: BorderRadius.circular(6),
          ),
          child: Text(
            badge,
            style: TextStyle(
              color: isDarkMode ? (badgeColor == const Color(0xFFFEE500) ? const Color(0xFFFEE500) : badgeColor) : badgeColor,
              fontSize: 11.5,
              fontWeight: FontWeight.w800,
            ),
          ),
        ...
        ...bullets.map(
          (bullet) => Padding(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Icon(CupertinoIcons.checkmark_alt_circle_fill, color: Color(0xFF6366F1), size: 16),
    ...
    final previewBox = Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: isDarkMode ? Colors.black.withValues(alpha: 0.4) : const Color(0x14000000),
            blurRadius: 28,
